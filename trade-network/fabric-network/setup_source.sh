...
export MSP=${FABRIC_SRC}/fabric-sdk-node/fabric-network/e2e/fabric/localfabric/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
