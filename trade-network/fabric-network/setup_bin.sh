...
if [[ ! -n "$FABRIC_BIN"  ]]; then
	export FABRIC_BIN=${PWD}/bin/linux/${VER}
fi
...
export MSP=${PWD}/fabric/localfabric/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
